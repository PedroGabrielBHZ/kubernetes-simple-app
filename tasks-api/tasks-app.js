...
// Add a parser layer to the smelly onion
app.use(bodyParser.json());

// Add a headers layer to the smelly onion
...
const extractAndVerifyToken = async (headers) => {
  ...
  console.log("I am extracting and verifying tokens.")
...
app.get("/tasks", async (req, res) => {
  ...
  console.log("I received a request to get tokens.")
...
app.post("/tasks", async (req, res) => {
  ...
  console.log("I received a request to post tokens.")
